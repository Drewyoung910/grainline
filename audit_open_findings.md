...
Latest mechanical open-heading count after the 2026-05-05 payment webhook/refund pass: **9** broad unclosed numbered findings. This still overcounts duplicate/stale/design items, so each pass verifies reproducibility before code changes.

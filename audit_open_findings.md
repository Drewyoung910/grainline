...
4. **[LAUNCH BUSINESS BLOCKER OPEN 2026-05-08] Terms and Privacy still display `DRAFT — Under Attorney Review`.** This remains intentionally open until attorney sign-off removes the public draft banners; it was not "fixed" in code because removing the warning without sign-off would hide a real legal launch gate.

...
Latest mechanical open-heading count after the 2026-05-05 listing publish/re-review pass: **2** broad unclosed numbered findings. This still overcounts duplicate/stale/design items, so each pass verifies reproducibility before code changes.

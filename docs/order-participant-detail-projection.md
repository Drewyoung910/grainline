...
- `grainline_order_buyer_detail_v2(text, text)`; and
...
redaction, exact snapshot keys, v1 runtime revocation, and v2-only runtime
execution. Application tests prove both pages use the named v2 functions and
...
table privilege, row, deployment, credential, or provider state. Merge,
guarded migration application, pooled-runtime proof, compatible application

-- DRAFT ONLY: generation-bound paid Checkout -> Order/OrderItem authority.
--
-- This candidate requires order-checkout-source-snapshot.sql and a drained
-- predecessor checkout epoch. It is not a production migration and does not
-- enable RLS or revoke any predecessor table authority.

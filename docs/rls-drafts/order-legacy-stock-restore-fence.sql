-- Compatible Order authority moving the legacy unordered-checkout Order-existence fence inside the already
...
-- migration changes no table, policy or table grant.

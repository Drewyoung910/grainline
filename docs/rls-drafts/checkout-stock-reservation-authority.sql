...
ALTER TABLE public."CheckoutStockReservation"
  ...
  ADD CONSTRAINT "CheckoutStockReservation_items_check"
  CHECK (public.grainline_checkout_reservation_items_valid("reservedItems", "payloadHash", "sellerId")) NOT VALID;
...
ALTER TABLE public."CheckoutStockReservation"
  VALIDATE CONSTRAINT "CheckoutStockReservation_items_check";

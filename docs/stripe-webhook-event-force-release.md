...
release remained a separate boundary and was subsequently applied through its
own guarded workflow; see
`docs/checkout-stock-reservation-authority-release.md` and

...
6. Continue the Order/payment/shipping program: StripeWebhookEvent policyless
   ...
   processed test-mode webhook lease retained. The read-only predecessor
   inventory and zero-direct-access proof are prepared and CI-enforced; execute
   the exact-ID drain before activation. See
   ...
   `docs/seller-payout-event-predecessor-drain.md`; keep Order,

...
| `Notification` | `PLANNED_RLS` | Bucket B Notification | Direct user-owned reads and mark-read updates with cross-user and system creation | Fifteen emission paths have family validation drafts; narrow the remaining 39, resolve legacy cleanup and social/message/commission concurrency, and choose the recipient hot-read design before staging |

...
6. Continue the Order/payment/shipping program: StripeWebhookEvent policyless
   ...
   but remains unmerged and unapplied with production wiring separately gated.
   See

...
`OrderPaymentEvent` has complete retained policyless Phase-A acceptance from
exact main `aec47e6a104f1fa54b6ee0e894751850d51390ec`, CI `33361381594` and
read-only pooled-runtime evidence SHA-256
`d4acc792856d0a3260cff9d597a27d6335650b2820536175f4f725185e7c7bfd`.
Fourteen tables now have production RLS; thirteen are FORCE-hardened and
`OrderPaymentEvent` is the one accepted Phase-A table awaiting its separate
posture-only FORCE release. Every remaining row is **not active RLS** and
remains work to design, prove, and promote.
...
> **Current OrderPaymentEvent release note (2026-08-31):** exact main

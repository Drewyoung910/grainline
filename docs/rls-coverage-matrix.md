...
| `Case` | `BLOCKED_DESIGN` | Case and case message | Dispute narrative, status and refund identifiers; buyer, seller, staff, cron and Stripe | Active Phase 4 conversion is pinned at 80 protected references across 29 sources and 26 fixed operations; land the compatible source/claim schema, convert all direct access, then promote strict invariants before policy SQL |

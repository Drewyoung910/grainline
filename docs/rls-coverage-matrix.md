...
>
> PR #307 merged that correction as exact main
> `2836e51d0ceb91ce05756dc5138e7c337e02a503`; CI `33220013251` passed. The
> cleanup-only restart completed from the same paid fixture, proved both signed
> deliveries and exact replays plus the 541-cent refund/475-cent reversal and
> private `SOLD_OUT` stock restoration, then removed all marker-bound
> application/Redis/provider fixtures while retaining only two processed
> webhook leases and ordinary immutable test-provider telemetry. The canary was
> restored, the restart journal removed, and no live money, configuration or
> secret exposure occurred. Sanitized mode-`0600` automatic-success evidence
> SHA-256 is
> `dafb43dbe1de3e0b65da8a3554b465b1aaa74282ee56779f3fb34b209a6c27a7`.
> The fresh blocked-checkout provider-proof gate is closed. Predecessor drain,
> remaining authority-family proofs and invariants, actor-safe projections and
> aggregates, and separate ENABLE/FORCE releases remain open.

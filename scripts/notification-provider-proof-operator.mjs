    ...
    for (const fixture of providerFixtures()) {
      ...
      await owner.query(
        `INSERT INTO public."Notification" (
           ...
           ($1::text, $6::text, 'NEW_MESSAGE', 'Provider message', 'Provider message body', $11::text,
            'message', $1::text, $12::text, $7::text, false, pg_catalog.clock_timestamp() - interval '4 minutes'),
           ($2::text, $6::text, 'LOW_STOCK', 'Provider low stock', 'Provider low stock body', $10::text,
            'manual_low_stock', $2::text, $13::text, $7::text, false, pg_catalog.clock_timestamp() - interval '3 minutes'),
           ($3::text, $6::text, 'NEW_ORDER', 'Provider order', 'Provider order body', $14::text,
            'order', $3::text, $15::text, $7::text, false, pg_catalog.clock_timestamp() - interval '2 minutes'),
           ($4::text, $6::text, 'NEW_FAVORITE', 'Provider read', 'Provider read body', $10::text,
            'favorite', $4::text, $16::text, $7::text, true, pg_catalog.clock_timestamp() - interval '1 minute'),
           ($5::text, $7::text, 'ACCOUNT_WARNING', 'Provider foreign', 'Provider foreign body', NULL,
            'account_warning', $5::text, $17::text, $6::text, false, pg_catalog.clock_timestamp() - interval '5 minutes')`,
        [
          fixture.messageId,
          fixture.lowStockId,
          fixture.orderId,

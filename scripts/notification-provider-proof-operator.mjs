...
export const PROVIDER_PROOF_BRANCH = "codex/rls-notification-provider-proof-4-20260722";
...
export const REVIEWED_STAGING_BRANCH_ID = "br-tiny-violet-aavfq7w4";
export const REVIEWED_STAGING_BRANCH_NAME = "notification-provider-proof-4-20260722";
export const REVIEWED_STAGING_ENDPOINT_ID = "ep-raspy-sea-aayr0tt3";
...
export const PROVIDER_PROOF_STATE_PATH =
  "/private/tmp/grainline-notification-provider-proof-state-4-20260722.json";
export const PROVIDER_BYPASS_STATE_PATH =
  "/private/tmp/grainline-notification-provider-bypass-4-20260722.json";

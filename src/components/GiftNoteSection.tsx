...
export default function GiftNoteSection({
  ...
  const giftNoteCounterId = `${giftNoteId}-counter`;
    ...
    <div className="space-y-3">
      ...
      {isGift && (
        <div className="space-y-3 pl-6">
          <div>
            <label htmlFor={giftNoteId} className="block text-sm font-medium text-neutral-700 mb-1">
            ...
            <textarea
              ...
              rows={3}
              maxLength={200}
              aria-describedby={giftNoteCounterId}
              className="w-full rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm"
            />
            <p id={giftNoteCounterId} aria-live="polite" className="text-xs text-neutral-500 text-right">
              {giftNote.length}/200
            </p>
          </div>

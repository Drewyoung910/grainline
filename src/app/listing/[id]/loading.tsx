  ...
  return (
    <main className="p-8 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="aspect-square w-full bg-neutral-200 rounded-xl border animate-pulse" />
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
        {Array.from({ length: 6 }).map((_, i) => (
          <div key={i} className="aspect-square bg-neutral-200 rounded-lg border animate-pulse" />
        ))}
      </div>
    </main>
  );

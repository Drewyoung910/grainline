...
describe("disposable Notification provider proof operator", () => {
  ...
  it("builds only the exact reviewed staging database identities", () => {
    ...
    assert.equal(
      ...
      "ep-empty-breeze-aans7eqe-pooler.westus3.azure.neon.tech",
    );
    assert.equal(new URL(owner).hostname, "ep-empty-breeze-aans7eqe.westus3.azure.neon.tech");
    ...
    assert.throws(() => validateDatabaseUrl(
      runtime.replace("ep-empty-breeze-aans7eqe", "ep-plain-river-aaqg8gj4"),

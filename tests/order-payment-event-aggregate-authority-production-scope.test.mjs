    ...
    triggers: applied ? [
      {
        ...
        definition:
          'CREATE TRIGGER grainline_order_payment_projection_guard BEFORE INSERT OR UPDATE OF "paymentRefundBlocked", "paymentConversionDisputeBlocked" ON public."Order" FOR EACH ROW EXECUTE FUNCTION grainline_order_payment_projection_guard()',
      },
      {
        ...
        function_owner: "neondb_owner",
        definition:
          'CREATE TRIGGER grainline_order_payment_projection_refresh AFTER INSERT ON public."OrderPaymentEvent" FOR EACH ROW EXECUTE FUNCTION grainline_order_payment_projection_refresh()',
      },
    ] : [],

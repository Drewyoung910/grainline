...
describe("Bucket B Notification RLS inventory", () => {
  ...
  it("keeps asymmetric writes, staged activation, and blockers explicit", () => {
    ...
    assert.match(strategy, /Final byte-pinned SQL\/authority\s+review and disposable migration\/rollback proof remain separate/);
    ...
    assert.match(plan, /Latest accepted run `29893071538`/);

...
const securityHeaders = [
  ...
  { key: "Reporting-Endpoints", value: 'csp-endpoint="/api/csp-report"' },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://cdn.thegrainline.com https://*.r2.dev https://*.r2.cloudflarestorage.com https://utfs.io https://ufs.sh https://*.ufs.sh https://i.postimg.cc https://img.clerk.com https://images.clerk.dev https://*.clerk.com https://*.clerk.accounts.dev https://q.stripe.com https://*.tile.openstreetmap.org https://tiles.openfreemap.org",
      ...
      "media-src 'self' https://cdn.thegrainline.com https://*.r2.dev https://*.r2.cloudflarestorage.com https://utfs.io https://ufs.sh https://*.ufs.sh",
      "object-src 'none'",
      "base-uri 'self'",

...
const securityHeaders = [
  ...
  { key: "Strict-Transport-Security", value: "max-age=63072000; includeSubDomains; preload" },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://clerk.com https://api.stripe.com https://hooks.stripe.com https://*.uploadthing.com https://utfs.io https://*.sentry.io https://*.ingest.sentry.io https://major-toad-67912.upstash.io https://nominatim.openstreetmap.org https://*.tile.openstreetmap.org wss://*.clerk.accounts.dev wss://*.clerk.com",
      // Stripe payment iframe + Clerk account modal iframe
      "frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.com",

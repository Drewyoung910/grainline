...
const securityHeaders = [
  ...
  { key: "Reporting-Endpoints", value: 'csp-endpoint="/api/csp-report"' },
  {
    ...
    value: [
      ...
      `img-src 'self' data: blob: ${r2PublicOrigins} https://utfs.io https://ufs.sh https://*.ufs.sh https://img.clerk.com https://images.clerk.dev https://*.clerk.com https://*.clerk.accounts.dev https://q.stripe.com https://*.tile.openstreetmap.org https://tiles.openfreemap.org`,
      // All XHR/fetch/WebSocket targets: Clerk, Stripe, R2, Sentry, Upstash, OpenStreetMap, Maplibre tiles
      `connect-src 'self' https://*.clerk.accounts.dev https://*.clerk.com https://clerk.com https://clerk.thegrainline.com https://accounts.thegrainline.com https://api.stripe.com https://hooks.stripe.com https://checkout.stripe.com ${cloudflareTurnstileOrigin} ${r2PublicOrigins} ${r2ApiOrigin} https://*.sentry.io https://*.ingest.sentry.io https://major-toad-67912.upstash.io https://nominatim.openstreetmap.org https://*.tile.openstreetmap.org https://tiles.openfreemap.org wss://*.clerk.accounts.dev wss://*.clerk.com wss://clerk.thegrainline.com`,
      // Stripe payment iframe + Clerk account modal iframe + YouTube/Vimeo embeds on blog posts
      `frame-src 'self' https://js.stripe.com https://hooks.stripe.com https://checkout.stripe.com https://*.clerk.accounts.dev https://*.clerk.com https://clerk.com https://clerk.thegrainline.com https://accounts.thegrainline.com ${cloudflareTurnstileOrigin} https://www.youtube-nocookie.com https://player.vimeo.com`,
...
export default withSentryConfig(nextConfig, {
  ...
  webpack: {
    // App Router cron route handlers use explicit check-ins through
    // src/lib/cronMonitor.ts. The automatic Vercel monitor integration only
    // covers Pages Router API handlers.
